...
<head>
  ...
  <body>
	...
	<div id="tb" style="padding:5px;height:auto">
		...
		<a href="#" title="下载随访人员报告(PDF文档)" class="easyui-linkbutton" iconCls="icon-acrobat" plain="true" onclick="downReportWord();">认证报告-个人(PDF)</a>
		<a href="#" title="批量下载随访人员报告(PDF文档)" class="easyui-linkbutton" iconCls="icon-acrobat" plain="true" onclick="downReportCollectionWord();">认证报告-批量(PDF)</a>
