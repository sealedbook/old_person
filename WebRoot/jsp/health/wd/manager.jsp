...
<head>
  ...
  <body>
	<table id="dg" title="随访人员认证审核(外地)" style="width:98%;height:750px;" data-options="
				rownumbers:true,
				fit : true,
				singleSelect:false,
				autoRowHeight:false,
		...
		<thead>
			<tr>
				...
				<th field="oldPerson" formatter="formatOldPerson" align="center" width="10%">随访人员姓名</th>
				...
				<th field="oldPersonArea" formatter="formatOldPersonArea" align="center" width="20%">随访人员所属地区</th>
