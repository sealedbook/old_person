...
$(function(){
	$('#userCreateButton').click(function(){
		...
		$.ajax({
			type:"POST",
			url:'<c:url value="/operator/add.do" />',
			dataType:'text',
	    ...
	    <form id="userForm" method="post">
	    	<table class="tableStyle">
				<tr>
					...
					<td width="30%"><input class="easyui-textbox" name="name" id="name" data-options="required:true,validType:['blankSpace','length[0,10]']"/></td>
					<td width="20%" class="right">身份证号</td>
					<td width="30%"><input class="easyui-textbox" name="idCard" id="idCard" data-options="required:true,validType:['blankSpace','checkIdCard[]']"/></td>
				</tr>
				<tr>
					...
					<td>
						<input class="easyui-textbox" name="phoneNumber" id="phoneNumber" data-options="validType:['blankSpace']"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<input class="easyui-textbox" data-options="validType:['blankSpace'],width:'90%'" name="homeAddress" id="homeAddress"/>
					</td>
				</tr>
	    	</table>
	    </form>
