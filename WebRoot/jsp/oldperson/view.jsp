...
<script type="text/javascript">
	$(function(){
		$('#dg').datagrid({
			...
			onDblClickRow: function(rowIndex,rowData){
				...
				top.openDialog({onClose:function(){},width:'50%',height:'90%',title:'认证信息',url:url});
			}
		});
		$('#wddg').datagrid({
		});
  ...
  <body>
 	<table class="tableStyle">
   		...
   		<tr>
   			<td width="15%" class="right">发放状态</td>
   			<td><code2name:dictionary code="${oldPerson.ffStatus}" parentId="ffStatus" /></td>
   	...
   	<c:choose>
   		<c:when test="${oldPerson.type == '1' }">
	   		<table id="dg" title="认证记录" data-options="
				...
				<thead>
					<tr>
						<th field="beginDateTime" formatter="esite.formatDate"  pattern="yyyy-MM-dd HH:mm" align="center" width="20%">开始认证时间</th>
						...
						<th field="fingerVerifyState" formatter="esite.convertCode2Name" parentId="fingerVerifyState" align="center" width="15%" >指纹识别</th>
						<th field="verifyState" formatter="esite.convertCode2Name" parentId="shzt" align="center" width="15%" >最终认证状态</th>
						<th field="insertDateTime" formatter="esite.formatDate"  pattern="yyyy-MM-dd HH:mm" align="center" width="18%" >同步时间</th>
					</tr>
				</thead>
			</table>
   		</c:when>
   			...
   			<table id="wddg" title="认证记录" data-options="
				...
				<thead>
					<tr>
						...
						<th field="verifyState" formatter="esite.convertCode2Name" parentId="shzt" align="center" width="30%" >最终认证状态</th>
						<th field="insertDateTime" formatter="esite.formatDate"  pattern="yyyy-MM-dd HH:mm" align="center" width="23%" >同步时间</th>
					</tr>
				</thead>
			</table>
   		</c:otherwise>
