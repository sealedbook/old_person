...
public class StringHelper {
	...
	public static int countTokens(String seperators, String list,
			boolean ignoreCase) {
	...
	private static String generateAliasRoot(String description) {
		final String result = truncate(unqualifyEntityName(description),
	...
	public static String generateParamterExpress(String token,
			String seperators, int count) {
	...
	/** * 检查日期格式 * * @param year * @param month * @param day * @return */
	...
	public static Object createUUID() {
